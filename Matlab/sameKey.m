...
if i==1
    ...
    elseif i==3
    vettmillisecc= [Aval, Bval, Cval, Dval, Eval];
    elseif i==4
    vettmillisecd= [Aval, Bval, Cval, Dval, Eval];
    elseif i==5
    vettmillisece= [Aval, Bval, Cval, Dval, Eval];
end
...
hold on
plot(vettSample,vettmillisecb, 'DisplayName', 'Blowfish');
plot(vettSample,vettmillisecc, 'DisplayName', 'RC5');
plot(vettSample,vettmillisecd, 'DisplayName', 'RC6');
plot(vettSample,vettmillisece, 'DisplayName', 'TwoFish');
